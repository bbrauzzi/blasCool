...
- baseCommand: spectral-index
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/scombi-do:dev0.4.22
  id: clt
  inputs:
    input_reference:
      inputBinding:
