...
- baseCommand: combi
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/scombi-do:dev0.4.16
  id: clt
  inputs:
    red_channel:
      inputBinding:
  ...
  requirements:
    EnvVarRequirement:
      envDef:
        APP_DOCKER_IMAGE: docker.terradue.com/scombi-do:dev0.4.16
        APP_LOGGING: https://faas.terradue.com/function/metrics-collect-on-demand-services-uat
        APP_NAME: combi
        APP_PACKAGE: app-combi.dev.0.4.16
        APP_VERSION: 0.4.16
