...
- baseCommand: opt-calibration
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/opt-calibration:dev0.9.4
  id: clt
  inputs:
    input_path:
      inputBinding:
