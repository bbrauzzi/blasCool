...
- baseCommand: opt-calibration
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/opt-calibration:dev0.6.69
  id: clt
  inputs:
    input_path:
      inputBinding:
