$graph:
  - baseCommand: mosaic
    ...
    requirements:
      ...
      DockerRequirement:
        dockerPull: docker.terradue.com/aux-mosaic:0.7.1-feature-gdadr-47
  - class: Workflow
