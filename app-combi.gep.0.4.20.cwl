...
- baseCommand: combi
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/scombi-do:gep0.4.20
  id: clt
  inputs:
    red_channel:
      inputBinding:
  ...
  requirements:
    EnvVarRequirement:
      envDef:
        APP_DOCKER_IMAGE: docker.terradue.com/scombi-do:gep0.4.20
        APP_NAME: combi
        APP_PACKAGE: app-combi.gep.0.4.20
        APP_VERSION: 0.4.20
