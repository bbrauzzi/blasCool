...
- baseCommand: opt-calibration
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/opt-calibration:dev0.6.55
  id: clt
  inputs:
    input_path:
      inputBinding:
