...
- baseCommand: opt-calibration
  ...
  hints:
    DockerRequirement:
      dockerPull: docker.terradue.com/opt-calibration:dev0.8.3
  id: clt
  inputs:
    input_path:
      inputBinding:
